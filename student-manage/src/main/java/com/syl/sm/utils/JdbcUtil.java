...
public class JdbcUtil {
    private static final String URL = "jdbc:mysql://localhost:3306/student_manager?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&serverTimezone=GMT%2B8";
